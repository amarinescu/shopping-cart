...
{
    public class AddArticleToBasketCommandHandlerTests
    {
        [Fact]
        public async Task Handle_HappyPath_EndsWithSuccess()
        {
            //Arrange
            var request = new AddArticleToBasketCommand()
            {
                Item = "tomato",
                Price = 10
            };
            ...
            var ev = new Event
            {
                ...
                Entity = JsonSerializer.Serialize(new Article { Item = request.Item, Price = request.Price })
            };
            ...
            var handler = new AddArticleToBasketCommand.Handler(mockBasketRepository.Object, mockEventRepository.Object, mockKafkaProducer.Object);
